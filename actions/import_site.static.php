...
function run()
{
	...
	if(is_dir(BOLMER_BASE_PATH . 'temp/import'))       $filedir = BOLMER_BASE_PATH . 'temp/import/';
	elseif(is_dir(BOLMER_BASE_PATH . 'assets/import')) $filedir = BOLMER_BASE_PATH . 'assets/import/';
